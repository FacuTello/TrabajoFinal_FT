...
function Electronica()
{
    ...
    return (
        <Container>
            <h1 className="text-center mt-4 mb-4">Productos de Electronica</h1>
            <Row className="justify-content-center">
                {productos.map(producto=>(    
                    <Col md={4} className="mt-4" key={producto.id}>
                        <Card className="d-flex flex-column text-center rounded" style={{ width: '300px', height: '460px', border: '4px solid black' }}>
